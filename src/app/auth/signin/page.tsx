            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between text-sm">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    type="checkbox"
                    className="w-4 h-4 rounded border-savanna-cream-400 text-savanna-gold-500 focus:ring-savanna-gold-500"
                  />
                  <span className="text-savanna-earth-600">Remember me</span>
                </label>
                <Link
